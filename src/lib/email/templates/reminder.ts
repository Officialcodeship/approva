...
<title>Reminder: content awaiting your review</title>
</head>
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <h1 style="margin:0 0 12px;font-size:22px;font-weight:700;color:#18181b;line-height:1.3;">
                Friendly reminder — content waiting for you
              </h1>
              <p style="margin:0 0 8px;font-size:15px;color:#52525b;line-height:1.6;">
                Just a heads-up that <strong style="color:#18181b;">${escapeHtml(workspaceTitle)}</strong> is still waiting on your approval. It only takes a couple of minutes.
              </p>
              <p style="margin:0 0 28px;font-size:15px;color:#52525b;line-height:1.6;">
                Approve posts, request changes, or leave comments — no account needed.
              </p>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid #f4f4f5;">
              <p style="margin:0;font-size:12px;color:#a1a1aa;">
                You received this because ${escapeHtml(agencyName)} is waiting on your approval for
                <em>${escapeHtml(workspaceTitle)}</em>. No account needed — just click the link above.
              </p>
            </td>
          </tr>
        </table>
